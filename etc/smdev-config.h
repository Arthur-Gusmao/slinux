...
struct rule {
	...
	{ "hvc[0-9]*",    "root", "tty",   0660, NULL,      NULL                           },
	{ "pty.*",        "root", "tty",   0660, NULL,      NULL                           },
	{ "vcs[0-9]*",    "root", "tty",   0660, NULL,      NULL                           },
	{ "vcsa*[0-9]*",  "root", "tty",   0660, NULL,      NULL                           },
	{ "sd[a-z]+([0-9]*)?", "root", "disk", 0660, NULL, NULL                       },
	{ "vd[a-z]+([0-9]*)?", "root", "disk", 0660, NULL, NULL                       },
	{ "nvme[0-9]+(n[0-9]+(p[0-9]+)?)?", "root", "disk", 0660, NULL, NULL           },
	{ "mmcblk[0-9]+(p[0-9]+)?", "root", "disk", 0660, NULL, NULL                  },
	{ "loop[0-9]+",   "root", "disk",  0660, NULL,      NULL                           },
	{ "sr[0-9]+",     "root", "cdrom", 0660, NULL,      "@ln -sf $DEVNAME /dev/cdrom"  },
	{ "fb[0-9]*",     "root", "video", 0660, NULL,      NULL                           },
	{ "input/.*",     "root", "input", 0640, "=input/", NULL                           },
	{ "dri/.*",       "root", "video", 0660, "=dri/",   NULL                           },
	{ "snd/.*",       "root", "audio", 0660, "=snd/",   NULL                           },
	{ "midi.*",       "root", "audio", 0660, NULL,      NULL                           },
	{ "seq",          "root", "audio", 0660, NULL,      NULL                           },
	{ "timer",        "root", "audio", 0660, NULL,      NULL                           },
